    ...
    <form onSubmit={placeOrder} className='place-order'>
      <div className="place-order-left">
       ...
       <div className="multi-fields">
        <input required type="text" name="first_name" onChange={onChangeHandler} value={data.first_name} placeholder='First Name'/>
        <input required type="text" name="last_name" onChange={onChangeHandler} value={data.last_name} placeholder='Last Name'/>
       </div>
